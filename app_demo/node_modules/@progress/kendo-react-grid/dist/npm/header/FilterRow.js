    ...
    FilterRow.prototype.render = function () {
        ...
        var filterCells = this.props.columns.filter(function (c) { return c.children.length === 0; })
            ...
            var filterCellProps = column.filterable && {
                ...
                operators: filterCommon_1.operatorMap(_this.props.filterOperators[filterType] || [], localizationService),
                booleanValues: filterCommon_1.operatorMap(filterCommon_1.booleanFilterValues, localizationService),
        ...
        return React.createElement("tr", { className: exports.FILTER_ROW_CLASS, role: "row" }, filterCells);
    };
    return FilterRow;
}(React.Component));
