 ...
 * @hidden
 */
exports.GridHierarchyCell = function (props) {
    ...
    if (props.rowType === 'groupFooter') {
        ...
        defaultRendering = (React.createElement("td", __assign({ className: "k-hierarchy-cell" }, navigationAttributes, { onKeyDown: onKeyDownHandler }),
