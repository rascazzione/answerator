...
var Grid = /** @class */ (function (_super) {
    ...
    Grid.prototype.render = function () {
        ...
        var dataRow = function (item, rowId) {
            var isInEdit = false;
            return {
        ...
        if (data.length) {
            data.forEach(function (item, rowIndex) {
                ...
                var rowId = dataItemKey ? dataItemKey : absoluteIndex(rowIndex);
                var rowDetailId = rowId + '_1';
                var gridRow = dataRow(item, rowId);
                ...
                if (_this.props.detail && item.rowType === 'data' && item.expanded) {
                    var detailColspan = (_this._columns.filter(function (c) { return !c.children.length; }).length
                        - (_this.props.expandField ? 1 : 0)
                        - (_this.props.group ? _this.props.group.length : 0)) || 1;
                    body.push((React.createElement("tr", { key: rowDetailId, className: isAlt ? 'k-detail-row k-alt' : 'k-detail-row', style: { visibility: hidden(rowIndex) ? 'hidden' : '' } },
                        _this.props.group && _this.props.group.map(function (group, idx) {
                            return (React.createElement(GridGroupCell_1.GridGroupCell, { id: '', dataIndex: item.dataIndex, field: group.field, dataItem: item.dataItem, key: idx, style: {} }));
                        }),
                        _this.props.expandField && React.createElement("td", { className: "k-hierarchy-cell" }),
                        React.createElement("td", { className: "k-detail-cell", colSpan: detailColspan },
                            React.createElement(_this.props.detail, { dataItem: item.dataItem, dataIndex: item.dataIndex })))));
                }
            });
        }
        else {
            body.push((React.createElement("tr", { className: "k-grid-norecords" },
        ...
        if (this.props.scrollable === 'none') {
            return (React.createElement(kendo_react_data_tools_1.TableKeyboardNavigationContext.Provider, { value: this.contextStateRef.current },
                React.createElement("div", __assign({ style: this.props.style, className: kendo_react_common_1.classNames('k-widget k-grid', this.props.className), ref: function (el) { _this.element = el; }, onKeyDown: this.onKeyDown, onFocus: this.onFocus }, kendo_react_data_tools_1.tableKeyboardNavigationScopeAttributes),
                    toolbar,
                    groupingPanel,
        ...
        return (React.createElement(kendo_react_data_tools_1.TableKeyboardNavigationContext.Provider, { value: this.contextStateRef.current },
            React.createElement("div", __assign({ style: wrapperStyle, className: kendo_react_common_1.classNames('k-widget k-grid', {
                    ...
                    _this.element = el;
                    _this.resetTableWidth();
                }, role: "grid", onKeyDown: this.onKeyDown, onFocus: this.onFocus }, kendo_react_data_tools_1.tableKeyboardNavigationScopeAttributes),
                toolbar,
                groupingPanel,
                header,
                React.createElement("div", { className: "k-grid-container", role: "presentation" },
                    React.createElement("div", { ref: function (container) { _this.vs.container = container; }, className: "k-grid-content k-virtual-content", onScroll: this.scrollHandler, role: "presentation" },
                        React.createElement("div", { style: { 'position': 'relative' }, role: "presentation" },
                            React.createElement("table", { tabIndex: -1, className: 'k-grid-table', ref: function (table) { return _this.vs.table = table; }, role: "presentation" },
                                colGroups,
                                React.createElement("tbody", __assign({ ref: function (tableBody) { _this.vs.tableBody = tableBody; }, role: "presentation" }, kendo_react_data_tools_1.tableKeyboardNavigationBodyAttributes), body))),
