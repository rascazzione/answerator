...
exports.Chip = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement("div", { id: props.value, style: props.style, ref: chipRef, dir: dir, tabIndex: kendo_react_common_1.getTabIndex(props.tabIndex, props.disabled, undefined), className: kendo_react_common_1.classNames('k-chip', 'k-chip-filled', {
            'k-rtl': dir === 'rtl',
