...
var InternalTile = /** @class */ (function (_super) {
    ...
    InternalTile.prototype.render = function () {
        ...
        if (clearTimeout && typeof (clearTimeout) === 'function') {
            ...
            this.preventDataOps = setTimeout(function () { _this.preventDataOps = undefined; }, 200);
        }
        ...
        var card = (React.createElement("div", { ref: function (e) { _this.draggable = e ? ({ element: e }) : null; }, className: kendo_react_common_1.classNames('k-tilelayout-item k-card', { 'k-cursor-grab': reorderable }, this.props.className), style: __assign({ height: '100%' }, this.props.style) },
            this.props.children,
        ...
        return (React.createElement("div", { ref: function (e) { _this.element = e; }, style: itemStyles, className: this.props.hintClassName }, reorderable ? (React.createElement(kendo_react_common_1.Draggable, { ref: function (e) { _this.draggable = e; }, onDrag: this.handleDrag, onRelease: this.handleRelease, onPress: this.handlePress }, card)) : card));
    };
    /**
     * @hidden
     */
...
exports.InternalTile = InternalTile;
