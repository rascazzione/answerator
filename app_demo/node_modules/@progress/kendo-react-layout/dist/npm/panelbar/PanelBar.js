...
var PanelBar = /** @class */ (function (_super) {
    ...
    function PanelBar(props) {
        ...
        _this._selectionService = new selectionService_1.SelectionService(_this.onSelect, _this.onFocus, _this.props.expandMode || 'multiple');
        _this._navigationService = new navigationService_1.NavigationService(_this.onNavigate);
        return _this;
    }
