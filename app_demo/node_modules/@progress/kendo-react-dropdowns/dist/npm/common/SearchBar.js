...
var SearchBar = /** @class */ (function (_super) {
    ...
    SearchBar.prototype.render = function () {
        var _this = this;
        var _a = this.props, _b = _a.expanded, expanded = _b === void 0 ? false : _b, disabled = _a.disabled, _c = _a.role, role = _c === void 0 ? 'listbox' : _c;
        return [(React.createElement("span", { className: "k-searchbar", key: "searchbar" },
            ...
            this.props.clearButton && React.createElement(ClearButton_1.default, { onClick: this.props.clearButtonClick, key: "clearbutton" })
        ];
    };
    return SearchBar;
}(React.Component));
