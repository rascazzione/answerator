...
exports.MultiColumnComboBox = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement(ComboBox_1.default, __assign({ list: MultiColumnList_1.MultiColumnList, header: header, itemRender: itemRender, onChange: handleChange, popupSettings: __assign({ width: popupWidth }, popupSettings, { className: kendo_react_common_1.classNames('k-dropdowngrid-popup k-popup-flush', popupSettings.className) }) }, other)));
});
